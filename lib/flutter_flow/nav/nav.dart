...
class AppStateNotifier extends ChangeNotifier {
  MainBaseFirebaseUser? initialUser;
  MainBaseFirebaseUser? user;
  ...
  void update(MainBaseFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, _) => appStateNotifier.loggedIn ? NavBarPage() : LoginWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          ...
          routes: [
            ...
            FFRoute(
              name: 'dash',
              path: 'dash',
              builder: (context, params) => params.isEmpty ? NavBarPage(initialPage: 'dash') : DashWidget(),
            ),
            FFRoute(
              name: 'homePage',
              path: 'homePage',
            ...
            FFRoute(
              name: 'profilePage',
              path: 'profilePage',
              builder: (context, params) => params.isEmpty ? NavBarPage(initialPage: 'profilePage') : ProfilePageWidget(),
            ),
            FFRoute(
              name: 'createPost',
              path: 'createPost',
            ...
            FFRoute(
              ...
              builder: (context, params) => PostDetailsWidget(
                postReference: params.getParam('postReference', ParamType.DocumentReference, false, 'userPosts'),
            ...
            FFRoute(
              ...
              builder: (context, params) => StoryDetailsWidget(
                initialStoryIndex: params.getParam('initialStoryIndex', ParamType.int),
              ),
            ),
            FFRoute(
              name: 'editSettings',
            ...
            FFRoute(
              ...
              builder: (context, params) => ChatPageWidget(
                ...
                chatRef: params.getParam('chatRef', ParamType.DocumentReference, false, 'chats'),
              ),
            ),
            FFRoute(
              name: 'allChatsPage',
              path: 'allChatsPage',
              builder: (context, params) => params.isEmpty ? NavBarPage(initialPage: 'allChatsPage') : AllChatsPageWidget(),
            ),
            FFRoute(
              name: 'addChatUsers',
              path: 'addChatUsers',
