                                  ...
                                  child: Container(
                                    ...
                                    child: Align(
                                      ...
                                      child: Container(
                                        ...
                                        child: Image.network(
                                          valueOrDefault<String>(
                                            viewProfilePageOtherUsersRecord.photoUrl,
                                  ...
                                  onPressed: () async {
                                    context.pushNamed(
                                      ...
                                      extra: <String, dynamic>{
                                        'chatUser': viewProfilePageOtherUsersRecord,
                                      },
                                    );
                                  },
                                  text: 'Message',
                            ...
                            children: [
                              Container(
                                ...
                                child: StreamBuilder<List<DogsRecord>>(
                                  stream: queryDogsRecord(
                                    queryBuilder: (dogsRecord) => dogsRecord.where('userAssociation', isEqualTo: viewProfilePageOtherUsersRecord.reference),
                                  ),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
                                    if (!snapshot.hasData) {
                                    ...
                                    List<DogsRecord> columnDogsRecordList = snapshot.data!;
                                    return Column(
                                      mainAxisSize: MainAxisSize.max,
                                      children: List.generate(columnDogsRecordList.length, (columnIndex) {
                                        final columnDogsRecord = columnDogsRecordList[columnIndex];
                                        return Padding(
                              ...
                              StreamBuilder<List<UserPostsRecord>>(
                                stream: queryUserPostsRecord(
                                  queryBuilder: (userPostsRecord) => userPostsRecord.where('postUser', isEqualTo: viewProfilePageOtherUsersRecord.reference).orderBy('timePosted', descending: true),
                                ),
                                builder: (context, snapshot) {
                                  // Customize what your widget looks like when it's loading.
                                  if (!snapshot.hasData) {
                                                                  ...
                                                                  child: Row(
                                                                    ...
                                                                    children: [
                                                                      ToggleIcon(
                                                                        ...
                                                                        value: socialFeedUserPostsRecord.likes!.toList().contains(userPostUsersRecord.reference),
                                                                        onIcon: Icon(
