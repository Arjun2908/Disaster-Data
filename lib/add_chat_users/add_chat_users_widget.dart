...
class _AddChatUsersWidgetState extends State<AddChatUsersWidget> {
  ...
  List<UsersRecord> get checkboxListTileCheckedItems => checkboxListTileValueMap.entries.where((e) => e.value).map((e) => e.key).toList();
                                ...
                                child: Padding(
                                  ...
                                  child: Theme(
                                    ...
                                    child: CheckboxListTile(
                                      value: checkboxListTileValueMap[listViewUsersRecord] ??= widget.chat!.users!.toList().contains(listViewUsersRecord.reference),
                                      onChanged: (newValue) => setState(() => checkboxListTileValueMap[listViewUsersRecord] = newValue!),
                                      title: Text(
