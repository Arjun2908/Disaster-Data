                      ...
                      children: [
                        PageView.builder(
                          ...
                          itemBuilder: (context, pageViewIndex) {
                            final pageViewUserStoriesRecord = pageViewUserStoriesRecordList[pageViewIndex];
                            return Column(
                              mainAxisSize: MainAxisSize.max,
                              children: [
                                Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              decoration: BoxDecoration(
                                                gradient: LinearGradient(
                                                  colors: [FlutterFlowTheme.of(context).primaryDark, Color(0x001A1F24)],
                                                  stops: [0, 1],
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Padding(
                                                    padding: EdgeInsetsDirectional.fromSTEB(16, 12, 16, 36),
                                                    child: StreamBuilder<UsersRecord>(
                                                      stream: UsersRecord.getDocument(pageViewUserStoriesRecord.user!),
                                                      builder: (context, snapshot) {
                                                        // Customize what your widget looks like when it's loading.
                                                        if (!snapshot.hasData) {
                                                          return Center(
                                                        ...
                                                        return Row(
                                                          ...
                                                          children: [
                                                            ...
                                                            if (pageViewUserStoriesRecord.isOwner ?? true)
                                                              Card(
                                            ...
                                            Container(
                                              ...
                                              decoration: BoxDecoration(
                                                gradient: LinearGradient(
                                                  colors: [Color(0x001A1F24), FlutterFlowTheme.of(context).primaryDark],
                                                  stops: [0, 1],
                                                  begin: AlignmentDirectional(0, -1),
                                                  end: AlignmentDirectional(0, 1),
                                                ),
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            FlutterFlowIconButton(
                                              ...
                                              onPressed: () async {
                                                await Share.share('This post is really awesome!');
                                              },
                                            ),
                                          ],
                                        ),
                          ...
                          child: Padding(
                            ...
                            child: smooth_page_indicator.SmoothPageIndicator(
                              ...
                              effect: smooth_page_indicator.ExpandingDotsEffect(
                                ...
                                activeDotColor: FlutterFlowTheme.of(context).tertiaryColor,
